...
function Model() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const internshipsCollectionRef = collection(userDocRef, "publications");
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            <div className="flex items-center mb-3">
              ...
              <button
                ...
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm w-20 p-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Add Skill
              </button>
            </div>
